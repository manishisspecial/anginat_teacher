    ...
    <div className="bg-white border border-gray-200 rounded-lg p-4 mb-3 shadow-sm">
      ...
      <div className="grid grid-cols-2 gap-3 text-sm">
        ...
        <div>
          ...
          <span className="ml-2 text-green-600 font-medium">{item.present}</span>
        </div>
        <div>
          <span className="text-gray-500">Absent:</span>
          <span className="ml-2 text-red-600 font-medium">{item.absent}</span>
        </div>
        <div>
          <span className="text-gray-500">Half Day:</span>
          <span className="ml-2 text-orange-600 font-medium">{item.halfDay}</span>
        </div>
      </div>
    </div>
  );
      ...
      <div className="w-full">
        ...
        <div className="bg-white rounded-lg shadow p-4 md:p-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <h2 className="text-lg md:text-xl font-bold text-gray-900">Class Attendance</h2>
