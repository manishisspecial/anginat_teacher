    ...
    <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
      ...
      <div className="space-y-2">
        ...
        <div className="flex justify-between text-sm">
          ...
          <span className="text-gray-900 font-medium">{student.class}</span>
        </div>
        <div className="flex justify-between text-sm">
          <span className="text-gray-600">Section:</span>
          <span className="text-gray-900 font-medium">{student.section}</span>
        </div>
      </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="p-4 md:p-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
              <h2 className="text-lg md:text-xl font-semibold text-gray-900">Student Attendance</h2>
