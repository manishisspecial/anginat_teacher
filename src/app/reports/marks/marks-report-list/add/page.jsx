...
export default function AddStudentMarksPage() {
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.subjects.some(subject => isNaN(subject.marks) || subject.marks < 0 || subject.marks > 100)) {
    ...
    // Navigate back to marks report list
    try {
      router.push('/reports/marks/marks-report-list')
    } catch (error) {
      console.error('Navigation error:', error)
      window.location.href = '/reports/marks/marks-report-list'
    }
  }
