...
export default function ExamAttendancePage() {
  ...
  const filteredAttendance = attendanceData.filter(item =>
    ...
    (filterSubject === '' || Object.keys(item.attendance).includes(filterSubject)) &&
    (filterStatus === '' || Object.values(item.attendance).includes(filterStatus))
  )
  ...
  const MobileAttendanceCard = ({ item }) => (
    <div className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
      ...
      <div className="space-y-2">
        <div className="text-xs font-medium text-gray-600 mb-2">Subject Attendance:</div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="p-4 md:p-6">
            ...
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-6">
              <h2 className="text-lg md:text-xl font-bold text-gray-900">Attendance</h2>
