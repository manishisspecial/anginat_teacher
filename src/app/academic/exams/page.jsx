...
export default function ExamsPage() {
  ...
  // Mock data for exams (100 items) with both In Progress and Completed statuses
  const examsData = Array.from({ length: 100 }, (_, index) => {
    const examNames = ['Quarterly', 'Half Yearly', 'Annual', 'Mid Term', 'Unit Test', 'Final Exam', 'Pre Board', 'Mock Test']
    ...
    const status = statuses[index % statuses.length] // Alternate between different statuses
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-semibold text-gray-900">Exams List</h2>
                ...
                <tbody>
                  {currentData.map((exam) => (
                    <tr key={exam.id} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="py-3 px-4 text-gray-900">{exam.id}</td>
                      <td className="py-3 px-4 text-gray-900">{exam.examName}</td>
                      <td className="py-3 px-4 text-gray-900">{exam.class}</td>
                      <td className="py-3 px-4 text-gray-900">{exam.examDate}</td>
                      <td className="py-3 px-4 text-gray-900">{exam.status}</td>
                      <td className="py-3 px-4">
                        <button
