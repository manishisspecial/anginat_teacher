...
export default function AssignmentsPage() {
  ...
  const MobileAssignmentCard = ({ item }) => (
    <div className="bg-white border border-gray-200 rounded-lg p-4 mb-3 shadow-sm">
      <div className="flex justify-between items-start mb-3">
        <div>
          <div className="font-medium text-gray-900">{item.id}</div>
          <div className="text-sm text-gray-500">Class {item.class} - {item.subject}</div>
        </div>
        <input
          type="checkbox"
      ...
      <div className="grid grid-cols-2 gap-3 text-sm mb-3">
        ...
        <div>
          ...
          <span className="ml-2 text-gray-900">{item.submissionDate}</span>
        </div>
      </div>
      ...
      <div className="mt-6">
        ...
        <div className="space-y-3">
          {currentData.map((item) => (
            <MobileAssignmentCard key={item.id} item={item} />
          ))}
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="p-4 md:p-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
              <h2 className="text-lg md:text-xl font-bold text-gray-900">Assignment List</h2>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-200">
                    ...
                    <th className="text-left py-3 px-4 font-semibold text-gray-900">Submission date</th>
